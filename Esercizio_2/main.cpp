...
int main(int argc, char *argv[])
{
    ...
    cout << "MergeSort is a more efficient algorithm for large unordered vectors and has a complexity equal to "
            "O(n log(n)), while BubbleSort is more efficient for already sorted or slightly perturbed vectors "
            "and has a complexity equal to O(n^2)" << endl;
